...
// WithActionToUser tells the query-builder to eager-load the nodes that are connected to
// the "ActionToUser" edge. The optional arguments are used to configure the query builder of the edge.
...
func (aq *ActionQuery) sqlAll(ctx context.Context) ([]*Action, error) {
	...
	if query := aq.withActionToUser; query != nil {
