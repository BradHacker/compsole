...
func HasTokenToUser() predicate.Token {
	return predicate.Token(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(TokenToUserTable, UserFieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, TokenToUserTable, TokenToUserColumn),
		)
...
func HasTokenToUserWith(preds ...predicate.User) predicate.Token {
	return predicate.Token(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TokenToUserInverseTable, UserFieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, TokenToUserTable, TokenToUserColumn),
		)
